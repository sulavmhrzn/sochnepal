            ...
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
                        SochNepal is a social accountability platform where
                        citizens can report civic issues like broken roads,
                        garbage piles, power outages, and more. Together, we can
